    ...
    <aside class="sidebar">
        <div class="sidebar-menu">
            ...
            <div class="dropdown-container">
                ...
                <a href="{{route('settings')}}">Add Limit Configuration for Sensor</a>
                <a href="{{route('index.configuration')}}">List Limit Configuration Sensor</a>
            ...
            <div class="dropdown-container">
                <a href="{{route('admin.report')}}">Daily Report </a>
