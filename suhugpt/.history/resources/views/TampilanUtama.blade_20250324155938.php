...
function fetchData{{ $alat->id_mesin }}() {
    let limit = document.getElementById("limit_{{ $alat->id_mesin }}").value; // Ambil nilai limit dari input
    let second = document.getElementById("second_{{ $alat->id_mesin }}")/value;
