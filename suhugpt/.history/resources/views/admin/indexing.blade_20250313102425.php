...
<button onclick="fetchData({{ $alat->id_mesin }})" style="background-color: blue; color: white; padding: 4px 8px; border: none; border-radius: 5px; cursor: pointer;">Update</button>
            ...
            <div style="background: red; position: relative; width: 100px; height: 100px;">
                <a href="{{ route('history', ['id_mesin' => $alat->id_mesin, 'ip_address' => $alat->ip_address]) }}"
                    ...
                    position: absolute; top: 1px; right: 1px; border-radius: 50%;">
                ...
                <p style="position: absolute; top: 55px; right: 20px; margin: 0;">1</p>
                <p style="position: absolute; top: 70px; right: 20px; margin: 0;">2</p>
            </div>
