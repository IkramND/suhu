...
<body>
    ...
    <div class="login-dark">
        <form action="{{ route('alats.update', $alat->id) }}" method="POST">
            ...
            <div class="form-group">
                <input type="text" class="form-control" id="ip_address" name="ip_address" value="{{ $alat->ip_address }}" placeholder="IP Address" required>
            </div>

            <div class="form-group">
                <input type="text" class="form-control" id="lokasi" name="lokasi" value="{{ $alat->lokasi }}" placeholder="Lokasi" required>
            </div>

            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block">Update</button>
            </div>
            <a href="{{ route('card.index') }}" class="btn btn-primary btn-block">Cancel</a>
        </form>
    </div>
    @endforeach
