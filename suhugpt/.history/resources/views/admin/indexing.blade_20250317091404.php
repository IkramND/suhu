...
<button onclick="fetchData({{ $alat->id_mesin }})" style="background-color: blue; color: white; padding: 4px 8px; border: none; border-radius: 5px; cursor: pointer;">Update</button>
            ...
            <div style="position: relative; width: 120px; height: 120px; display: flex; flex-direction: column; align-items: center; justify-content: center; background: red; border-radius: 10px; padding: 10px;">
                ...
                <a href="{{ route('history', ['id_mesin' => $alat->id_mesin, 'ip_address' => $alat->ip_address]) }}"
                    ...
                    border-radius: 50%; position: absolute; top: 5px; right: 5px; background: white; box-shadow: 0px 0px 5px rgba(0,0,0,0.2);">
                ...
                <div style="background: palegoldenrod; width: 100%; padding: 10px; text-align: center; margin-top: 30px; border-radius: 5px;">
                    <h5><span id="lastUpdateTemperature_{{ $alat->id_mesin }}"></span> °C</h5>
