...
function updateLastSensorData(id_mesin) {
    $.ajax({
        ...
        success: function(data) {
            if (data) {
                document.getElementById(`suhu_${id_mesin}`).textContent = data.suhu ? data.suhu : 'No Data';
                document.getElementById(`kelembaban_${id_mesin}`).textContent = data.kelembaban ? data.kelembaban : 'No Data';
            } else {
                document.getElementById(`suhu_${id_mesin}`).textContent = 'No Data';
                document.getElementById(`kelembaban_${id_mesin}`).textContent = 'No Data';
            }
        },
        error: function() {
