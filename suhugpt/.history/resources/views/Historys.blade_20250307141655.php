...
function fetchDataHistory(startDate = '', endDate = '') {
    ...
    const day = String(date.getDate()).padStart(2, '0'); // Mengambil hari dan menambahkan nol di depan jika perlu
    const month = String(date.getMonth() + 1).padStart(2, '0'); // Mengambil bulan (0-11) dan menambahkan nol di depan
    const year = date.getFullYear(); // Mengambil tahun

    return `${day}-${month}-${year}`; // Format: xx-xx-xxxx
