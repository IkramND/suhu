            ...
            <div class="card">
                <div class="pisah" style="grid-template-columns: 7fr 7fr 1fr; display:grid;">
                    ...
                    <div style="background:rebeccapurple">
                        ...
                        Amount of data :
                    <input type="number" id="limit_{{ $alat->id_mesin }}" name="limit_{{ $alat->id_mesin }}" min="1" max="16" required oninput="validateInput(this)" style="width: 11%">
                    ...
                    <span style="color:grey;"> <i style="font-weight:normal"> ( max 24 )</i></span>
                        <br>
                        <br>
                    ...
                    <div style="justify-content:center;display:block;text-align:center;border:1px solid black;border-radius:10%;padding-bottom:10%">

                        <h3><span id="lastUpdateTemperature_{{ $alat->id_mesin}}"></span></h3>
                        <hr style="border: 1px solid black;width:50%">
                        <h3><span id="lastUpdateHumidity_{{ $alat->id_mesin}}"></span></h3>
                        </div>
                </div>
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.length === 0) {
                ...
                document.getElementById("lastUpdateTemperature_{{ $alat->id_mesin}}").textContent = " empty ";
                document.getElementById("lastUpdateHumidity_{{ $alat->id_mesin}}").textContent = " empty ";
            ...
            document.getElementById("lastUpdateTemperature_{{ $alat->id_mesin}}").textContent = tempData[tempData.length - 1];
