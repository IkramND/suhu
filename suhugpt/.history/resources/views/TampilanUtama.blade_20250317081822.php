    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.length === 0) {
                ...
                document.getElementById("lastUpdateTemperature_{{ $alat->id_mesin}}").textContent = "Null"
                document.getElementById("lastUpdateHumidity_{{ $alat->id_mesin}}").textContent = "Null"
