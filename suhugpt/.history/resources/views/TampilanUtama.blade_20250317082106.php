            ...
            <div class="card">
                <div class="pisah" style="grid-template-columns: 7fr 7fr 1fr; display:grid;">
                    ...
                    <div style="background:brown">
                        <p><span id="lastUpdateTemperature_{{ $alat->id_mesin}}"></span></p>
                        <hr style="border: 1px solid black">
                        <p><span id="lastUpdateHumidity_{{ $alat->id_mesin}}"></span></p>
...
function fetchData{{ $alat->id_mesin }}() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            document.getElementById("lastUpdateHumidity_{{ $alat->id_mesin}}").textContent = humData[humD.length - 1]
