...
function fetchData{{ $alat->id_mesin }}() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            document.getElementById("lastUpdateTemperature{{ $alat->id_mesin}}").textContent = tempData[tempData.length - 1];
            document.getElementById("lastUpdateHumidity{{ $alat->id_mesin}}").textContent = humData[humD.length - 1]
