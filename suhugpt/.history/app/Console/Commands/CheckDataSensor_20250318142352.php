        ...
        while (true) {
            ...
            if ($latest_id != $data->sensor_id || $index == 0) {
                ...
                if (!empty($message)) {
                    ...
                    $response = Http::timeout(5)->post("https://api.telegram.org/bot7866691074:AAE5eM1rqLAI_KBSTr6F0MjNQ9vsGTqtLPc/sendMessage?chat_id=1180884469&text=Tes%20pesan%20dari%20browser
", [
