...
class ReportController extends Controller
{
    ...
    public function processStep2(Request $request){
        ...
        $sensorData = Sensor::select(
            ...
            DB::raw('ROUND(AVG(suhu),2) as rata_rata_suhu'),
            DB::raw('ROUND(AVG(kelembaban),2) as rata_rata_kelembaban')
        )
        ...
        dd($sensorData->toSql(), $sensorData->getBindings());
        $sensorData = $query->get(); // Eksekusi query (tidak akan berjalan karena dd() sudah menghentikan eksekusi)
        ...
        // Sensor::where('id_mesin',$request->id_mesin)->whereBetween('waktu',[$request->start_date,$request->end_date])->delete();
