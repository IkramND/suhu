...
Route::post('/admin/add-emailconfiguration', [NotificationController::class, 'store'])->name('admin.add.notification');
Route::get('/admin/Emailconfigurartion-list', [NotificationController::class, 'index'])->name('admin.emailconfiguration.list');
