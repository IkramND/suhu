...
Route::get('/admin/Emailconfigurartion-list', [NotificationController::class, 'index'])->name('admin.configurationemail.list');
Route::get('/admin/EmailConfiguration-destroy/{id}', [NotificationController::class, 'destroy'])->name('admin.notification.destroy')
