...
use App\Http\Controllers\LokasiconfigurationController;
...
Route::delete('/configuration/{id}', [CardController::class, 'destroy'])->name('configurations.destroy');
Route::get('/configurations/{id}/edit', [CardController::class, 'edit'])->name('configurations.edit');

Route::put('/configurations/{id}', [CardController::class, 'update'])->name('configurations.update');

Route::get('/history', [HistoryController::class, 'index'])->name('history');
Route::get('/sensor/fetch-history', [HistoryController::class, 'fetchHistory']);
Route::get('/admin/editconfiguration/', [Cardcontroller::class, 'editconfiguration'])->name('Editconfiguration');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/sensor/lokasi', [SensorController::class, 'getLokasiconfiguration']);

    // Route::get('/configuration/{id}', [SensorController::class, 'show'])->name('configuration.show');
