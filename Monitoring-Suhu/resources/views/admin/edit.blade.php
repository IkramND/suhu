    ...
    <div class="container">
        ...
        <form action="{{ route('alats.update', $alat->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="id_mesin" id="id_mesin" class="form-control" value="{{ $alat->id_mesin }}"
                    required>
            </div>
            <div class="mb-3">
                <label for="title" class="form-label">ip_address</label>
                <input type="text" name="ip_address" id="ip_address" class="form-control"
                    value="{{ $alat->ip_address }}" required>
            </div>
            <div class="mb-3">
                <label for="title" class="form-label">lokasi</label>
                <input type="text" name="lokasi" id="lokasi" class="form-control" value="{{ $alat->lokasi }}"
                    required>
            </div>
