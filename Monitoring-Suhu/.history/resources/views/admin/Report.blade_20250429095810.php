...
<head>
    ...
    <style>
        ...
        .flatpickr-input {
            ...
            padding: 5px 10px;
            font-size: 14px;
            background-image: url('path_to_custom_icon.svg'); /* Ganti dengan path ikon Anda */
            background-repeat: no-repeat;
            background-position: right center;
            padding-right: 30px; /* Memberikan ruang untuk ikon */
        }
...
<body>
    ...
    <script>
        // Inisialisasi Flatpickr pada input start_date
        flatpickr("#start_date", {
            dateFormat: "Y-m-d",  // Format tanggal
            allowInput: true,     // Izinkan input manual
            wrap: true            // Membungkus input dengan elemen untuk pengaturan khusus
        });
