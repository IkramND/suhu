        ...
        <div
            ...
            <div class="card">
                <div class="pisah" style="grid-template-columns: 3fr 4fr 1fr; display: grid; position: relative;">
                    ...
                    <div
                        style="position: relative; width: 120px; height: 120px; display: flex; flex-direction: column; align-items: center; justify-content: center; border-radius: 10px; padding: 10px;">
                        <!-- Icon History -->
...
@section('main')
    <style>
        ...
        @media (max-width: 767px) {
            .pisah {
                all: unset;
                grid-template-columns: 8px 0px 1px !important;
            ...
            .pisah h4, .pisah input, .pisah button {
                font-size: 14px;
            }
            ...
            <div class="card">
                <div class="pisah" style="grid-template-columns: 3fr 4fr 1fr; display: grid; position: relative;">
                    ...
                    <div>
                        ...
                        <div style="display:flex;align-items:center;">
                            <h4 style="margin-bottom:0">Range data:</h4>
                            <input type="number" id="limit_{{ $alat->id_mesin }}" min="1" max="18" required oninput="validateInput(this)" style="width: 11%; margin-left:5%;margin-top:5%">
                            <button onclick="fetchData{{ $alat->id_mesin }}()" style="background-color: blue; color: white; padding: 4px 8px; border: none; border-radius: 5px; cursor: pointer;margin-top:5%;margin-left:2%">Update</button>
                            <span style="color:grey;margin-left:2%;margin-top:4%"> <i style="font-weight:normal">( max 18 )</i></span>
                        </div>
                        <div style="display:flex;align-items:center;">
                            <h4 style="margin-bottom:0">Duration data:</h4>
                            <input type="number" id="second_{{ $alat->id_mesin }}" required style="width: 11%;margin-left:12px;margin-top:5%">
                            <button onclick="fetchData{{ $alat->id_mesin }}()" style="background-color: blue; color: white; padding: 4px 8px; border: none; border-radius: 5px; cursor: pointer;margin-top:5%;margin-left:2%">Update</button>
                            <span style="color:grey;margin-left:2%;margin-top:4%"> <i style="font-weight:normal">( Default 1 Minute )</i></span>
                        </div>
                    </div>
                    <div style="position: relative; width: 120px; height: 120px; display: flex; flex-direction: column; align-items: center; justify-content: center; border-radius: 10px; padding: 10px;">
                        <a href="{{ route('history', ['id_mesin' => $alat->id_mesin, 'ip_address' => $alat->ip_address]) }}" class="tooltip-svg" style="color: black; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; border-radius: 50%; position: absolute; top: 5px; right: 5px; background: white;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 16 16">
                                <path d="..."/>
                            </svg>
                        </a>
                        <div style="width: 100%; padding: 10px; text-align: left; margin-top: 30px; border-radius: 5px;">
                            <div style="margin-left:60%;border-radius:10px;text-align:center;border:1px solid black;height:60%;margin-top:23%">
                                <h5 style="margin-bottom:25%;margin-top:25%"><span id="lastUpdateTemperature_{{ $alat->id_mesin }}"></span></h5>
                                <hr style="border: 1px solid black; width: 65%;margin-top:0;margin-bottom:0;">
                                <h5 style="margin-top:25%"><span id="lastUpdateHumidity_{{ $alat->id_mesin }}"></span></h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (humidityChart_{{ $alat->id_mesin }}) {
                            ...
                            humidityChart_{{ $alat->id_mesin }}.data.datasets[0].data = humData;
                            humidityChart_{{ $alat->id_mesin }}.update();
                        } else {
