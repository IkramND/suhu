...
<body>
    ...
    <div class="container">
        ...
        <p><strong>Day:<strong> {{\Carbon\Carbon::parse($dates)->format('d-m-Y')}}</p>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    {{-- <td class="highlight">{{ \Carbon\Carbon::parse($data->dates)->format('d-m-Y') }}</td> --}}
                    <td>{{ number_format($data->Jam,2) }}</td>
