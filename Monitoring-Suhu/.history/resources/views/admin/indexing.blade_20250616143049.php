...
@section('main')
    ...
    @foreach ($alats as $alat)
        ...
        <script>
            ...
            let screenwidth_{{ $alat->id_mesin}}; = window.innerWidth;
            let maxdata = document.getElementById("maxdata");

            if (screenwidth < 320) {
                maxdata.innerHTML = "( Max 10 )";
            } else if (screenwidth < 480) {
                maxdata.innerHTML = "( Max 12 )";
            } else if (screenwidth < 768) {
                maxdata.innerHTML = "( Max 15 )";
            } else {
                maxdata.innerHTML = "( Max 18 )";
            }
