...
<div class="login-dark">
  <form action="{{ route('report.result') }}" method="POST">
    ...
    <div class="form-group">
      {{-- <input class="form-control" type="month" name="month" placeholder="Month" required> --}}
      <input type="text" id="bulan" name="bulan" pattern="(0[1-9]|1[0-2])" placeholder="MM" maxlength="2" required>
