...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Pastikan tahun ditambahkan setelah halaman dimuat
    const currentYear = new Date().getFullYear();
    const startYear = 2025;
    const endYear = currentYear + 5;
    const yearOptions = document.getElementById('year-options');

    if (yearOptions) {  // Pastikan elemen #year-options ada
        ...
        // Pilih tahun pertama secara default
        ...
        if (firstYear) {
            ...
            yearDropdown.querySelector('.selected-text').textContent = firstYear.textContent; // Ganti teks dropdown tahun
            yearDropdown.querySelector('input[type="hidden"]').value = firstYear.getAttribute('data-value'); // Simpan nilai di input hidden
        }
    } else {
        console.error('#year-options tidak ditemukan!');
    }
