...
<body>
    <div class="login-dark">
        ...
        @endif
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" style="background: blue">Send Email</button></div>
        </form>
        @endif
        ...
        <form id="ReportForm" method="POST" action="{{ route('report.processStep2') }}">
            ...
            <div class="form-group"><input class="form-control flatpickr-input" type="text" id="customDateInput" placeholder="Select Start Date" name="start_date"></div>
            <div class="form-group">                <input class="form-control flatpickr-input" type="text" id="customDateInput" placeholder="Select Start Date" name="end_date"></div>
