...
<script>
    ...
    yearOptions.addEventListener('click', function (e) {
    const target = e.target;
    if (target.tagName === 'LI') {
        yearDropdown.querySelector('.selected-text').textContent = target.textContent; // Ganti teks dropdown tahun
        yearDropdown.querySelector('input[type="hidden"]').value = target.getAttribute('data-value'); // Simpan nilai di input hidden
        yearOptions.style.display = 'none';
        yearDropdown.querySelector('.dropdown-arrow').innerHTML = '&#9660;';
    }
});
