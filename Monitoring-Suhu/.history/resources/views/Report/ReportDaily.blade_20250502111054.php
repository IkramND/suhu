...
<body>
    ...
    <div class="login-dark" style="height: 100vh;">
        ...
        <form action="{{ route('reportdailypost') }}" method="POST">
...
o	Langkah-langkah Perakitan
o	Diagram Rangkaian
3.	Pemrograman Arduino
o	Instalasi Library yang Diperlukan
o	Sketsa Arduino (Source Code)
o	Upload Program ke Arduino
4.	Konfigurasi Server (Debian Linux)
o	Instalasi Apache, MySQL, PHP (LAMP Stack)
o	Konfigurasi Database MySQL
o	Instalasi Composer dan Laravel
5.	Pemrograman Backend (Laravel)
o	Setup Project Laravel
o	Koneksi Arduino ke Database MySQL
o	API untuk Komunikasi Data
6.	Deploy Aplikasi Laravel
o	Konfigurasi Virtual Host
o	Setting Permissions
o	Testing Aplikasi
7.	Panduan Penggunaan
o	Setting Awal untuk Admin
o	Panduan untuk User
            })
