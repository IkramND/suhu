...
document.addEventListener('DOMContentLoaded', function () {
    ...
    dropdown.forEach(function(dropdown) {
        ...
        selected.addEventListener('click', function (e) {
            ...
            // Menampilkan dropdown yang diklik
    ...
    // Membuat dropdown tahun
    const currentYear = new Date().getFullYear();
    const startYear = 2025;
    const endYear = currentYear + 5;
    const yearOptions = document.getElementById('year-options');
    const yearDropdown = document.querySelector('.custom-dropdown:last-child .dropdown-selected'); // Memilih dropdown terakhir
