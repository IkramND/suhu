...
class ReportController extends Controller
{
    ...
    public function processStep2(Request $request){
        ...
        $sensorData = Sensor::select(
            ...
            DB::raw('ROUND(MIN)suhu,2) as lowest_temperature'),
            DB::raw('ROUND(MAX)suhu,2) as highest_temperature'),
            DB::raw('ROUND(MIN)kelembaban,2) as lowest_humidity'),
            DB::raw('ROUND(MAX)kelembaban,2) as highest_humidity'),
