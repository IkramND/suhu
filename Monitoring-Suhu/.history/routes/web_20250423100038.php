...
Route::post('/forgot-password-2', [AuthController::class, 'showForgotPasswordForm2'])->name('forgot.password2');
...
Route::post('/validate-user', [AuthController::class, 'validateUser2'])->name('validate.user2');
Route::post('/validate-user', [AuthController::class, 'validateUser3'])->name('validate.user3');
